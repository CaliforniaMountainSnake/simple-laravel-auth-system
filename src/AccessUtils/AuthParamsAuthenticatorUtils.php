...
class AuthParamsAuthenticatorUtils
{
     ...
     * @param array       $_params    Request params.
     *
     * @return array The array with params that can be used to preform a POST query.
     */
    public function authPostParams(?string $_api_token, array $_params): array
    {
     ...
     */
    public function authGetParams(?string $_api_token, array $_params): string
    {
